...
export class BlockComponent implements OnInit {
  ...
  public generateRandomSvgPoints(): string {
    ...
    return `M50.8,-16.3C57.3,3.3,47.9,${pointB},${pointA},${pointD}C13.4,52.5,-11.9,51.9,-28.5,39.7C-${pointB},27.6,-52.9,3.9,-46.7,-15.3C-${pointC},-${pointE},-20.2,-49.5,1,-49.8C22.2,-50.1,44.4,-35.9,50.8,-16.3Z`;
  }
}
